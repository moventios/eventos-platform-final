...
import { CreateRoomSchema } from '@eventos/contracts';
import { CreateRoomHandler } from '@eventos/core/spatial';
import { DrizzleRoomRepository } from '@eventos/infrastructure/postgres/spatial';
