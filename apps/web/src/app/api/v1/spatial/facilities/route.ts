...
import { RegisterFacilitySchema } from '@eventos/contracts';
import { RegisterFacilityHandler } from '@eventos/core/spatial';
import { DrizzleFacilityRepository } from '@eventos/infrastructure/postgres/spatial';
import { OutboxEventBus, createDbWithTenant } from '@eventos/infrastructure/postgres';
import { facilities } from '@eventos/database/schema';
