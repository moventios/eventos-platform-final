...
export function LoginForm() {
  // Public-first: Encourage exploring the network before or after login.
  ...
  return (
    <main className="flex min-h-screen items-center justify-center">
      ...
      <div className="mt-8 pt-6 border-t text-center">
        ...
        <a href="/" className="text-primary underline">Explore the public Moventios Network — discover places, events and opportunities without signing in.</a>
      </div>
    </main>
  );
}