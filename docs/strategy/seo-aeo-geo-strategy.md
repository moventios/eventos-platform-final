...
> [Platform Name] is an AI-native Event & Project Operations Platform.
...
2. **Consistent category** — "Event & Project Operations Platform" — used consistently across all properties
