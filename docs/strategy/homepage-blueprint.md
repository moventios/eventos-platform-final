...
AI-Native Event & Project Operations Platform
...
```html
<title>Event & Project Operations Platform — Run Operations Without Chaos</title>
...
<meta property="og:title" content="Event & Project Operations Platform">
...
```json
{
  ...
  "description": "AI-native Event & Project Operations Platform for coordinating events, projects, venues, and finance with full audit trail.",
  "offers": {
    "@type": "Offer",
    "price": "0",
    "priceCurrency": "IDR",
