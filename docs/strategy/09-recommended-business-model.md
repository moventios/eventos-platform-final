...
## Model
- **Core**: Open source (AGPL or similar) + hosted SaaS.
- **Pricing**:
  - Free tier: Small events/projects (limited events, basic AI).
  - Pro: Per event or per organization + usage for AI/compute (inspired by Eventbrite per-ticket + Plane open-core).
  - Enterprise: Custom, on-prem/self-host support, SLAs, advanced AI, marketplace.
- **Additional**:
  - Marketplace: % on integrations, templates, vertical packs.
  - Services: Implementation, training, white-label.
