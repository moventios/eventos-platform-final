...
- **Lesson for us**: Lead with *operational outcomes* (reliability, visibility, accountability), then support with architecture proof. Never lead with "immutable ledger" — lead with "no dropped balls."
